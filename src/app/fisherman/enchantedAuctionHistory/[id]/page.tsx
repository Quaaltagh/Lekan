              ...
              <div className={styles.card}>
                <div className={styles.fishSection}>
                  ...
                  <div className={styles.fishMeta}>
                    <div className={styles.fishTagRow}><Fish size={12} /><span>Produk Lelang</span></div>
                    ...
                    <div className={styles.specsGrid}>
                      <div className={styles.specItem}><Calendar size={14} /><span>{formatDate(auction.created_at)}</span></div>
                      <div className={styles.specItem}><Clock size={14} /><span>Berakhir {formatDate(auction.ends_at)}</span></div>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        {auction.bids.map(bid => {
                          ...
                          return (
                            <tr key={bid.id} className={isHighest ? styles.highestBidRow : ''}>
                              <td className={styles.bidTimeCell}>{formatDateTime(bid.created_at)}</td>
                              <td>
