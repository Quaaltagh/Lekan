...
import { LayoutDashboard, Upload, Activity, Wallet, Settings, Bell, Search, TrendingUp, TrendingDown, Plus, History, BanknoteArrowDown } from 'lucide-react';
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col justify-between">
        <div>
          ...
          <nav className="p-4 space-y-1">
            ...
            <a href="#" className="flex items-center gap-3 text-slate-500 hover:bg-slate-50 px-4 py-3 rounded-xl font-medium"><History size={20} /> Histori Lelang</a>
            ...
            <a href="#" className="flex items-center gap-3 text-slate-500 hover:bg-slate-50 px-4 py-3 rounded-xl font-medium"><BanknoteArrowDown size={20} /> Tarik Dana</a>
